test_that("modify_agents: 'add_agents' works",{
  ...
  G2 <- modify_agents(G = G, G_agent_name = "agents", new_obj = new_agents, method = "add_agent")
...
test_that("modify_agents: add an object with 'add_attr_df'", {
  ...
  age <- c(11,12,13)
  G2 <- modify_agents(G = G, G_agent_name = "agents", new_obj = age, method = "add_attr_df")
...
test_that("modify_agents: add a data.frame with two columns with 'add_attr_df'", {
  G <- setABM(agents = init_agents(attr_df = data.frame(x = c(1,2,3))))
  G2 <- modify_agents(G = G, G_agent_name = "agents",
...
test_that("modify_agents: add an act_FUN with 'add_act_FUN'", {
  ...
  G2 <- modify_agents(G = G, G_agent_name = "agents", new_obj = new_act1, method = "add_act_FUN")
...
test_that("modify_agents: add two act_FUNs with 'add_act_FUN'", {
  ...
  G2 <- modify_agents(G = G, G_agent_name = "agents", new_obj = list(new_act1 = new_act1,
                                                                     new_act2 = new_act2),
                      method = "add_act_FUN")
...
test_that("modify_agents: add an active binding with 'add_active_binding'", {
  ...
  G2 <- modify_agents(G = G, G_agent_name = "agents", new_obj = random, method = "add_active_binding")
...
test_that("modify_agents: add two active bindings with 'add_active_binding'", {
  G <- setABM(agents = init_agents(attr_df = data.frame(x = c(1,2,3))))
  random <- function(){rnorm(1)}
  G2 <- modify_agents(G = G, G_agent_name = "agents", new_obj = list(random1 = random,
...
test_that("modify_agents: add two other_attrs with 'add_other_attrs'", {
  G <- setABM(agents = init_agents(attr_df = data.frame(x = c(1,2,3))))
  G2 <- modify_agents(G = G, G_agent_name = "agents", new_obj = list(y = c(4,5,6),
                                                                     z = list(matrix(1,2,2),
                                                                              matrix(2,2,2),
...
test_that("modify_agents: 'delete field' works", {
  G <- setABM(agents = init_agents(attr_df = data.frame(x = c(1,2,3))))
  G2 <- modify_agents(G = G, G_agent_name = "agents", field_name = "x", method = "delete")
...
test_that("modify_agents: 'rename' for scolar works", {
  G <- setABM(agents = init_agents(attr_df = data.frame(x = c(1,2,3))))
  G2 <- modify_agents(G = G, G_agent_name = "agents", field_name = "x", new_field_name = "x2", method = "rename")
...
test_that("modify_agents: 'rename' for active binding works", {
  ...
  G2 <- modify_agents(G = G, G_agent_name = "agents", field_name = "random", new_field_name = "random2", method = "rename")
...
test_that("modify_agents: 'rename' for act_FUN works", {
  ...
  G2 <- modify_agents(G = G, G_agent_name = "agents", field_name = "act_FUN", new_field_name = "act_FUN2", method = "rename")
...
test_that("modify_agents: 'copy' for scolar works", {
  G <- setABM(agents = init_agents(attr_df = data.frame(x = c(1,2,3))))
  G2 <- modify_agents(G = G, G_agent_name = "agents", field_name = "x", method = "copy", new_field_name = "x2")
...
test_that("modify_agents: 'copy' for act_FUN works", {
  ...
  G2 <- modify_agents(G = G, G_agent_name = "agents", field_name = "act", method = "copy", new_field_name = "act2")
...
test_that("modify_agents: 'copy' for active binding works", {
  random <- function(){rnorm(1)}
  G <- setABM(agents = init_agents(attr_df = data.frame(x = c(1,2,3)), active_binding_field = random))
  G2 <- modify_agents(G = G, G_agent_name = "agents", field_name = "random", method = "copy", new_field_name = "random2")
...
G2 <- modify_agents(G = G, G_agent_name = "agents", new_obj = 4:6, method = "replace", field_name = "x")
expect_true(G2$agents$ID1$x==4)
})

test_that("modify_agents: 'replace' works for a data.frame input", {
G <- setABM(agents = init_agents(n = 3, attr_df = data.frame(x = 1:3)))
G2 <- modify_agents(G = G, G_agent_name = "agents", new_obj = data.frame(4:6), method = "replace", field_name = "x")
expect_true(G2$agents$ID1$x==4)
})

test_that("modify_agents: 'replace' works for a data.frame even when the latter has more than 1 column", {
G <- setABM(agents = init_agents(n = 3, attr_df = data.frame(x = 1:3)))
G2 <- modify_agents(G = G, G_agent_name = "agents", new_obj = data.frame(4:6, 7:9), method = "replace", field_name = "x")
expect_true(G2$agents$ID1$x==4)
})

test_that("modify_agents: 'replace' stops when new_obj is a vector nested under a list.", {
  G <- setABM(agents = init_agents(n = 3, attr_df = data.frame(x = 1:3)))
  expect_error(modify_agents(G = G, G_agent_name = "agents", new_obj = list(x = 4:6), method = "replace", field_name = "x"))
})
...
test_that("modify_agents: 'replace' works when for list object.", {
  ...
  G2 <- modify_agents(G = G, G_agent_name = "agents", new_obj = list(mat2, mat2, mat2), method = "replace", field_name = "mat1")
...
test_that("modify_agents: 'delete_agent' works properly.", {
  ...
  G2 <- modify_agents(G = G, G_agent_name = "agents", method = "delete_agent", delete_agent_posit = c(2,3))
