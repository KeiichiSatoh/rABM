...
#'
#' @param G An object of class \code{ABM_G}. This is the source object to be copied.
#'
#' @return A deep copy of the input \code{ABM_G} object.
#'
#' @details
...
#'
#' @seealso \code{\link{ABM_G}}, \code{\link{modify_G}}
#'
#' @export

copy_G <- function(G){
  stopifnot("G must be the class 'ABM_G'." = class(G)[1]=="ABM_G")
  G$clone(deep = TRUE)
}
